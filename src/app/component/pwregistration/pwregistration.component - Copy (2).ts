...
this.fetchHealthProviderOnSubcentreAndVillage()
  ...
  onSubmit(pwregistrationForm) {
	...
	///////// DateofRegistration //////////////
       ...
       let	DateofRegistration_modified_date="2020-12-24T08:42:15.826Z"
		
		if(this.pwregistrationForm.controls['DateofRegistration'].value)
		{
			
			let Dor_Val = this.pwregistrationForm.controls['DateofRegistration'].value;
			if (Dor_Val.month < 10) {
      var month_val: string = "0" + Dor_Val.month;

    }
    else {
      var month_val: string = Dor_Val.month;
    }
    if (Dor_Val.day < 10) {
      var day_val: string = "0" + Dor_Val.day;

    }
    else {
      var day_val: string = Dor_Val.day;
    }

     DateofRegistration_modified_date = Dor_Val.year + '-' + month_val + '-' + day_val;
		}	
  ...
  "tMotherMedical": {
    ...
    "registrationNo": Number(pwregistrationForm.value.RCHID),
    "idNo": null,
    "lmpDate": LMPDate_modified_date,
    "reg12weeks": 0,
    "eddDate": eddDate_modified_date,
