...
this.searchForm.controls['HusbandFirstname'].enable();
  ...
  private createForm() {
    this.searchForm = this.formBuilder.group({
      PWfirstname: new FormControl('',[Validators.required,Validators.pattern('^[A-Z, a-z ,.-]+$'),this.noWhitespaceValidator]),
      HusbandFirstname: new FormControl('',[Validators.required,Validators.pattern('^[A-Z, a-z ,.-]+$'),this.noWhitespaceValidator]),
     // PWDOB: new FormControl(''),
      mobno: new FormControl('', [Validators.required,Validators.pattern('[6-9]{1}[0-9]{9}$'),this.patternMobValidator()]),
