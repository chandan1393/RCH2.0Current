  ...
  .subscribe(value => {
   ...
   funResendMobotp(mobno:string)
   {
	console.log('funResendMobotp');
	 ...
	 alert('OTP has been re-sent to your mobile number');
   }
...
if(Object.keys(res).length>0){
  ...
  alert('User registration request submitted successfully and will be verified by admin. After verification password will be sent to your email and mobile number');
this.router.navigate(['/login']);
...
// bs please not need to check below code according to return	
 ...
 this.errorresponse="Something went wrong. Please try again later"; 
	 ...
	 {
	 this.errorresponse="User already exist";
