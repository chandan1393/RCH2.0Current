...
this.h.clearHierarchy();
  ...
  get getUserName() :string{
       let fn=  this.getUser().firstName;
        let mn=this.getUser().middleName;
        let ln=this.getUser().lastName;
console.log((fn? fn : "")+(mn? mn : "")+(ln? ln : ""))
  return (fn? fn : "")+" "+(mn? mn : "")+" "+(ln? ln : "")
    ...
    return this.getUser().districtId;
     ...
     get healthblockid():number{
      return this.getUser().healthblockId;
       ...
       get SubCentre():number{
         return this.getUser().SubCentre;
       }
